    ...
    <section class="css-le8j8b">
        ...
        <div class="css-15qcwbn-StyledTabBarContainer e1szkzar1">
          <ul class="css-1gwdxtz-VisualUl-StyledTabBarUl e1szkzar2">
            ...
            <li class="css-s8lqsd-StyledTab e1szkzar0">유저</li>
          </ul>
        </div>
            ...
            <div class="css-1djzg97">
              <ul class="css-paz4zm-VisualUl">
                <li class="css-1tmgvat">
                  <a title="스파이더맨" class="css-1aaqvgs-InnerPartOfListWithImage" href="/ko-KR/users/ld0q0pW9Gq6Xn"><div class="css-cssveg">
                    ...
                    <div class="css-zoy7di">
                      <div class="css-qkf9j">
                        <div class="css-17vuhtq">
                          <div class="css-14hy3cw">스파이더맨</div>
                        </div>
                        <div class="css-1evnpxk-StyledSubtitle">
                          <div class="css-xpswhu">평가 810</div>
                        </div>
                      </div>
                      <div>
                        <button class="css-1cekuo0-StylelessButton">
                          팔로우
                        </button>
                      </div>
                    </div></a>
                ...
                <li class="css-1tmgvat">
                  <a title="스파이더맨" class="css-1aaqvgs-InnerPartOfListWithImage" href="/ko-KR/users/nkPvrPJ92Jxga"><div class="css-cssveg">
                      <div class="css-lmg4ew">
                        <div class="css-h6h0rq-ProfilePhotoImage"></div>
                      </div>
                    </div>
                ...
                <li class="css-1tmgvat">
                  <a title="스파이더맨" class="css-1aaqvgs-InnerPartOfListWithImage" href="/ko-KR/users/dP8v6NND9vWeJ"><div class="css-cssveg">
                      <div class="css-lmg4ew">
                        <div class="css-h6h0rq-ProfilePhotoImage"></div>
                      </div>
                    </div>
                    <div class="css-zoy7di">
                      <div class="css-qkf9j">
                        ...
                        <div class="css-1evnpxk-StyledSubtitle">
                          <div class="css-xpswhu">평가 25 • 컬렉션 1</div>
                        </div>
                      </div>
                      <div>
                        <button class="css-1cekuo0-StylelessButton">
                ...
                <li class="css-1tmgvat">
                  <a title="스파이더맨" class="css-1aaqvgs-InnerPartOfListWithImage" href="/ko-KR/users/Pznx9mPDpGx76"><div class="css-cssveg">
                      <div class="css-lmg4ew">
                        <div class="css-1bwd45j-ProfilePhotoImage"></div>
                      </div>
                    </div>
                    <div class="css-zoy7di">
                      <div class="css-qkf9j">
                        ...
                        <div class="css-1evnpxk-StyledSubtitle">
                          <div class="css-xpswhu">평가 30</div>
                        </div>
                      </div>
                      <div>
                        <button class="css-1cekuo0-StylelessButton">
                ...
                <li class="css-1tmgvat">
                  <a title="스파이더맨" class="css-1aaqvgs-InnerPartOfListWithImage" href="/ko-KR/users/WwRqo0oOYmvlz"><div class="css-cssveg">
                      <div class="css-lmg4ew">
                        <div class="css-h6h0rq-ProfilePhotoImage"></div>
                      </div>
                    </div>
                    <div class="css-zoy7di">
                      <div class="css-qkf9j">
                        ...
                        <div class="css-1evnpxk-StyledSubtitle">
                          <div class="css-xpswhu">평가 11</div>
                        </div>
                      </div>
                      <div>
                        <button class="css-1cekuo0-StylelessButton">
                ...
                <li class="css-1tmgvat">
                  <a title="스파이더맨" class="css-1aaqvgs-InnerPartOfListWithImage" href="/ko-KR/users/87Gv7ZyYZVqE6"><div class="css-cssveg">
                      <div class="css-lmg4ew">
                        <div class="css-h6h0rq-ProfilePhotoImage"></div>
                      </div>
                    </div>
                ...
                <li class="css-1tmgvat">
                  <a title="스파이더맨 시안" class="css-1aaqvgs-InnerPartOfListWithImage" href="/ko-KR/users/ZBm5RAM6ravd4"><div class="css-cssveg">
                      <div class="css-lmg4ew">
                        <div class="css-h6h0rq-ProfilePhotoImage"></div>
                      </div>
                    </div>
                    <div class="css-zoy7di">
                      <div class="css-qkf9j">
                        <div class="css-17vuhtq">
                          <div class="css-14hy3cw">
                            스파이더맨 시안<span src="data:image/svg+xml;base64," class="css-amcv0d"></span>
                          </div>
                        </div>
                        <div class="css-1evnpxk-StyledSubtitle">
                          <div class="css-xpswhu">평가 13</div>
                        </div>
                      </div>
                      <div>
                        <button class="css-1cekuo0-StylelessButton">
                ...
                <li class="css-1tmgvat">
                  <a title="스파이더맨" class="css-1aaqvgs-InnerPartOfListWithImage" href="/ko-KR/users/36lvX8oRA4vXd"><div class="css-cssveg">
                      <div class="css-lmg4ew">
                        <div class="css-r0k2gu-ProfilePhotoImage"></div>
                      </div>
                    </div>
                    <div class="css-zoy7di">
                      <div class="css-qkf9j">
                ...
                <li class="css-1tmgvat">
                  <a title="스파이더맨" class="css-1aaqvgs-InnerPartOfListWithImage" href="/ko-KR/users/JZ4vB9Z1MVqRX"><div class="css-cssveg">
                      <div class="css-lmg4ew">
                        <div class="css-8ykb9d-ProfilePhotoImage"></div>
                      </div>
                    </div>
                    <div class="css-zoy7di">
                      <div class="css-qkf9j">
                ...
                <li class="css-1tmgvat">
                  <a title="스파이더맨 " class="css-1aaqvgs-InnerPartOfListWithImage" href="/ko-KR/users/WRQxDQkBnmqdl"><div class="css-cssveg">
                      <div class="css-lmg4ew">
                        <div class="css-h6h0rq-ProfilePhotoImage"></div>
                      </div>
                    </div>
                ...
                <li class="css-1tmgvat">
                  <a title="스파이더 맨" class="css-1aaqvgs-InnerPartOfListWithImage" href="/ko-KR/users/8nPvyGrwDoxYo"><div class="css-cssveg">
                      <div class="css-lmg4ew">
                        <div class="css-h6h0rq-ProfilePhotoImage"></div>
                      </div>
                    </div>
                    <div class="css-zoy7di">
                      <div class="css-qkf9j">
                        <div class="css-17vuhtq">
                          <div class="css-14hy3cw">스파이더 맨</div>
                        </div>
                        <div class="css-1evnpxk-StyledSubtitle">
                          <div class="css-xpswhu"></div>
                        </div>
                ...
                <li class="css-1tmgvat">
                  <a title="ㄱㅏ승짱 / 스파이더맨" class="css-1aaqvgs-InnerPartOfListWithImage" href="/ko-KR/users/6NW5Q8PM6kv1Y"><div class="css-cssveg">
                      <div class="css-lmg4ew">
                        <div class="css-h6h0rq-ProfilePhotoImage"></div>
                      </div>
                    </div>
                    <div class="css-zoy7di">
                      <div class="css-qkf9j">
                        <div class="css-17vuhtq">
                          <div class="css-14hy3cw">
                            ㄱㅏ승짱 / 스파이더맨<span src="data:image/svg+xml;base64," class="css-amcv0d"></span>
                          </div>
                        </div>
                        <div class="css-1evnpxk-StyledSubtitle">
                          <div class="css-xpswhu"></div>
...
.css-10zg79x-pageMarginStyle {
    width: 100%;
    max-width: 1320px; 
}

.css-15qcwbn-StyledTabBarContainer {
    position: relative;
...
.css-1gwdxtz-VisualUl-StyledTabBarUl {
    list-style: none;
    padding: 0px;
    display: flex;
    box-sizing: border-box;
...
/* @media (min-width: 760px)  아니면100 */
.css-paz4zm-VisualUl > li {
    width: 50%;
}
...
.css-h6h0rq-ProfilePhotoImage {
    position: relative;
    z-index: 1;
    background: url(https://an2-glx.amz.wtchn.net/assets/default/user/photo_file_name_small-ab0a7f6….jpg) no-repeat center;
...
.css-1d4r906-StylelessButton > span {
    margin-left: 2px;
}
.css-cg0u6i {
    display: inline-block;
