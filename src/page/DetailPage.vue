...
<section class="detail-movie_info border-bottom">
            ...
            <div class="d-flex gap-4 basic-info">
                ...
                <div class="d-flex flex-column">
                    ...
                    <span id="categoryId" class="mb-2 text-secondary font-15">날짜・
                        장르1개</span>
                ...
                <div class="border bg-white p-4">
                    ...
                    <div>
                        <div class="d-flex justify-content-between mb-3">
                            <h2 class="d-flex gap-2"><b>코멘트</b><span class="color-pink">100+</span></h2>
                            <!-- {% if comments %} -->
                            ...
                            <li class="comment-card">
                                ...
                                <div class="d-flex align-items-center gap-3 border-bottom mb-2">
                                    <div class="d-flex align-items-center gap-2 py-2">
                                        ...
                                        <div class="font-14" id="like-count-{{ detail.id }}-{{ comment.id }}">좋아요수</div>
                                    </div>
                                    <div class="d-flex align-items-center gap-2">
                                        <span
                                            class="material-symbols-outlined text-secondary font-15">chat_bubble</span>
                                        <div class="font-14">댓글수</div>
                                    </div>
                                </div>
                                <form class="comment-like-forms" data-detail-id="{{ detail.id }}"
                                    data-comment-id="{{ comment.id }}"> 
                                    <input type="submit" id="like-{{ detail.id }}-{{ comment.id }}"
                                        class="comment-unlike_btn" value="좋아요">
