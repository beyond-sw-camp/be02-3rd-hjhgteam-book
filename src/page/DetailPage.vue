            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex gap-4 align-items-center">
                    ...
                    <router-link :to="`/detail/${id}/comment`">
                        <a type="button" id="open_modal" class="d-flex align-items-center gap-2 feature-btn">
                ...
                <div>
                    <div class="d-flex justify-content-between mb-3">
                        <h2 class="d-flex gap-2">
                            <b>코멘트</b><span class="color-pink">{{ contentCommentList.length }}</span>
                        </h2>
                        <!-- {% if comments %} -->
                    ...
                    <ul class="card-wrapper gap-3">
                        ...
                        <template v-for="(comment, index) in contentCommentList" :key="index">
                                    ...
                                    <div class="d-flex align-items-center gap-3 border-bottom mb-2">
                                        <div class="d-flex align-items-center gap-2 py-2">
                                            <span class="material-symbols-outlined text-secondary font-15"
                                                >thumb_up</span
                                            >
                                            <div class="font-14" id="like-count-{{ detail.id }}-{{ comment.id }}">
                                                좋아요수
                                            </div>
                                        </div>
